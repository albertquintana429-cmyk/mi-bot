...
module.exports = {
  name: "saytusoneclick", // Coloque o nome do comando
  description: "📦​ | Entrega Saytus One Click", // Coloque a descrição do comando
  ...
  run: async (client, interaction) => {
    ...
    let embed = new Discord.EmbedBuilder()
      ...
      .setDescription(
        `**•  __Producto__:** Saytus One Click <:st21:1403963874352300082>\n\n` +
        `**•  Key(s):** ||${key}||\n` +
        `**•  Download:** [Haz Click Aqui](https://www.mediafire.com/file/78e0qe5r9w1ld3e/Privacy_Protector_Console.rar/file)\n\n` +
