...
module.exports = {
  name: "quantumoneclick",
  description: "📦​ | Entrega Quantum One Click",
  ...
  execute: async (interaction) => {
    ...
    const embed = new EmbedBuilder()
      ...
      .setTimestamp()
      .setThumbnail("https://media.discordapp.net/attachments/1341125399853269094/1386162720650559518/logo.gif")
