...
module.exports = {
  name: "inimuoneclick",
  description: "📦​ | Entrega Inimu One Click",
  ...
  execute: async (interaction) => {
    ...
    const embed = new EmbedBuilder()
      ...
      .setTimestamp()
      .setThumbnail("https://cdn.discordapp.com/attachments/1357892619262361841/1360818889906454579/inimu.png")
      .setFooter({ text: bot, iconURL: avatar_bot })
      .setDescription(
        `**•  __Producto__:** Inimu One Click <:inimu:1411747582870556672>\n\n` +
        `**•  Key(s):** ||${key}||\n` +
        `**•  Download:** [Haz Click Aqui](https://inimuspoofer.xyz/files/inimu1click.exe)\n` +
        `**•  Tutorial:** ||https://inimu.gitbook.io/inimu-one-click/||\n\n` +
