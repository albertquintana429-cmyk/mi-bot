...
module.exports = {
  name: "stopped-woofer", // Nombre del comando
  description: "📦​ | Entrega Stopped Woofer", // Descripción
  ...
  run: async (client, interaction) => {
    ...
    const embed = new Discord.EmbedBuilder()
      ...
      .setDescription(
        `**•  __Producto__:** Stopped Woofer <:stopped:1376273781001158756>\n\n` +
        `**•  Key(s):** ||${key}||\n` +
        `**•  Download:** [Haz Click Aqui](https://discord.com/channels/1333382019211853854/1426698843243679794)\n` +
