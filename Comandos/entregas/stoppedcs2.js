...
module.exports = {
  name: "stopped-cs2", // Nombre del comando
  description: "📦​ | Entrega Stopped Cs2", // Descripción
  ...
  run: async (client, interaction) => {
    ...
    const embed = new Discord.EmbedBuilder()
      ...
      .setDescription(
        `**•  __Producto__:** Stopped Counter Strike <:stopped:1376273781001158756>\n\n` +
        `**•  Key(s):** ||${key}||\n` +
        `**•  Download:** [Haz Click Aqui](https://discord.com/channels/1333382019211853854/1426698061400379432)\n\n` +
