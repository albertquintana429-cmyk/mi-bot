...
module.exports = {
  name: "stopped-internal-basic", // Nombre del comando
  description: "📦​ | Entrega Stopped Internal Basic", // Descripción
  ...
  run: async (client, interaction) => {
    ...
    const embed = new Discord.EmbedBuilder()
      ...
      .setDescription(
        `**•  __Producto__:** Stopped Internal Basic <:stopped:1376273781001158756>\n\n` +
        `**•  Key(s):** ||${key}||\n` +
